...
texts = {
    'uz': {
        ...
        'ask_phone': "Telefon raqamingizni kiriting (masalan: +998 50 078 62 58):",
    ...
    'ru': {
        ...
        'ask_phone': "Введите ваш номер телефона (например: +998 50 078 62 58):",
    ...
    'en': {
        ...
        'ask_phone': "Enter your phone number (for example: +998 50 078 62 58):",
