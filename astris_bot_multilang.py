...
async def order(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    # Ortga tugmasi bilan buyurtma boshlash
    keyboard = [
        [InlineKeyboardButton(texts[lang]['back_button'], callback_data="cancel_order")]
    ]
...
async def get_name(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    # Ortga tugmasi bilan telefon so'rash
    keyboard = [
        [InlineKeyboardButton(texts[lang]['back_button'], callback_data="cancel_order")]
    ]
...
async def get_phone(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    # Xizmat turlarini tanlash uchun keyboard (ortga tugmasi bilan)
    keyboard = [
...
async def select_service(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    # Buyurtma haqida qo'shimcha ma'lumot so'rash (ortga tugmasi bilan)
    keyboard = [
        [InlineKeyboardButton(texts[lang]['back_button'], callback_data="cancel_order")]
    ]
...
async def cancel_order_callback(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    """Buyurtmani bekor qilish (callback query orqali)"""
    query = update.callback_query
    await query.answer()
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    # ANIQ TEXT MOSLASHTIRISH (emoji va matnlarni aniq tekshirish)
    if message_text == texts[lang]['services_button']:
        ...
        # Conversation handler orqali buyurtma boshlash
...
def main() -> None:
    ...
    order_conv_handler = ConversationHandler(
        ...
        states={
            ...
            XIZMATNI_TANLASH: [
                CallbackQueryHandler(select_service, pattern=r"^service_"),
                CallbackQueryHandler(cancel_order_callback, pattern=r"^cancel_order$")
            ],
            BUYURTMA_BERISH: [
    ...
    # Xabarlarni qayta ishlash handler-i
