...
# ADMIN_IDS = [7178547244]  # Bu joyga adminlarning Telegram ID raqamlari qo'yiladi
...
# # Suhbat bosqichlari
# ISMNI_OLISH, RAQAMNI_OLISH, XIZMATNI_TANLASH, BUYURTMA_BERISH = range(4)

# # Asosiy menyu tugmalari
# async def main_menu_keyboard():
#     keyboard = [
#         [KeyboardButton("ℹ️ Xizmatlar")],
#         [KeyboardButton("💵 Narxlar")],
#         [KeyboardButton("🗓 Bepul konsultatsiya uchun buyurtma qoldirish")],
...
#         f"<b>Astris Media</b> rasmiy botiga xush kelibsiz! 🚀\n\n"
#         f"Bizning xizmatlarimiz:\n"
#         f"• SMM\n"
#         f"• Target\n"
#         f"• Influencer marketing\n"
#         f"• Shaxsiy brend yaratish\n"
#         f"• Smm strategiya + kontent plan yaratish\n\n"
...
#     await update.message.reply_html(
#         "<b>Xizmatlarimiz narxlari:</b>\n\n"
#         "<b>Smm uchun to’liq mas’uliyat va to’liq komanda bilan::</b>\n"
#         "700$ - 1000$/oy\n\n"
...
#     await update.message.reply_html(
#         "Buyurtma qoldirish uchun quyidagi ma'lumotlarni kiritishingiz kerak.\n\n"
...
#         [InlineKeyboardButton("Target", callback_data="service_target")],
#         [InlineKeyboardButton("Influencer marketing", callback_data="service_influencer")],
#         [InlineKeyboardButton("Shaxsiy brend", callback_data="service_brand")],
#         [InlineKeyboardButton("Strategiya + Kontent plan", callback_data="service_content")]
#     ]
    
#     await update.message.reply_text(
#         "Qaysi xizmat turi siz qiziqtiradi?",
...
#     # Xizmat turini o'zbekchada ko'rsatish
#     services_uz = {
#         "smm": "SMM boshqaruv",
...
#         f"<b>Ism:</b> {context.user_data['ism']}\n"
#         f"<b>Telefon:</b> {context.user_data['telefon']}\n"
#         f"<b>Xizmat turi:</b> {context.user_data['xizmat']}\n"
#         f"<b>Qo'shimcha ma'lumot:</b> {context.user_data['qoshimcha']}\n\n"
...
#         f"<b>Telefon:</b> {context.user_data['telefon']}\n"
#         f"<b>Xizmat turi:</b> {context.user_data['xizmat']}\n"
#         f"<b>Qо'shimcha ma'lumot:</b> {context.user_data['qoshimcha']}\n\n"
...
#     if text == "ℹ️ Xizmatlar":
#         await services(update, context)
#     elif text == "💵 Narxlar":
#         await prices(update, context)
#     elif text == "🗓 Bepul konsultatsiya uchun buyurtma qoldirish":
#         return await order(update, context)
#     elif text == "✉️ Admin bilan bog'lanish":
...
#     # Conversation handler - buyurtmalar uchun
#     conv_handler = ConversationHandler(
#         entry_points=[
#             MessageHandler(filters.Text(["🗓 Bepul konsultatsiya uchun buyurtma qoldirish"]), order)
#         ],
#         states={
...
#     if text == "/language" or text == "/til" or text == "/yazyk":
#         await change_language(update, context)
#         return TILNI_TANLASH
    
#     if text == texts[lang]['services_button']:
#         await services(update, context)
#     elif text == texts[lang]['prices_button']:
#         await prices(update, context)
#     elif text == texts[lang]['order_button']:
#         return await order(update, context)
#     elif text == texts[lang]['contact_button']:
#         await contact_admin(update, context)
#     else:
#         await update.message.reply_text(
...
#         entry_points=[
#             MessageHandler(
#                 filters.Text([texts['uz']['order_button'], texts['ru']['order_button'], texts['en']['order_button']]), 
#                 order
#             )
#         ],
#         states={
...
#             CommandHandler("yazyk", change_language)  # 'язык' o'rniga 'yazyk' ishlatildi
#         ],
#         states={
#             TILNI_TANLASH: [CallbackQueryHandler(language_callback, pattern=r"^lang_")]
#         },
